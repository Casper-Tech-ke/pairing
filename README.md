...
<p align="center">
  <b>WhatsApp Bot Session Generator</b><br>
  A powerful web-based session generator for WhatsApp bots with Pair Code and QR Code support.
</p>
...
Sessions generated by this tool start with the prefix:

```
CASPER-XD-ULTRA;<session_data>
```

Use this format when configuring your WhatsApp bot.

---

## Deployment Guide

Deploy this project on any platform of your choice. Below are detailed instructions for each method.
...
**Step 3:** Once imported, click the **Run** button at the top. The app will start automatically on port 5000.
...
**Step 3:** Once deployed, click **View** to open your session generator.
...
**Step 3:** Connect your GitHub account and select the `CASPER-XD-ULTRA` repository
...
**Step 4:** Deploy and access your app via the provided URL
...
```bash
PORT=9989 pm2 start index.js --name casper-xd-ultra
pm2 startup
pm2 save
```

**Step 6:** Access your app at `http://your-server-ip:9989`

**Useful PM2 Commands:**
| Command | Description |
|---------|-------------|
| `pm2 logs casper-xd-ultra` | View live logs |
| `pm2 restart casper-xd-ultra` | Restart the app |
| `pm2 stop casper-xd-ultra` | Stop the app |
| `pm2 delete casper-xd-ultra` | Remove from PM2 |
...
- Application root: `/casper-xd-ultra`
...
After generating a session, you'll receive a session ID starting with `CASPER-XD-ULTRA;`. Here's how to use it in your bot:
